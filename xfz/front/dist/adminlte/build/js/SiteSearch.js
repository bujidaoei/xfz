...
const SiteSearch = (($) => {
  ...
  const DATA_KEY           = 'lte.site-course'
  ...
  const Selector = {
    TOGGLE_BUTTON  : '[data-widget="site-course"]',
    SEARCH_BLOCK   : '.site-course-block',
    SEARCH_BACKDROP: '.site-course-backdrop',
    SEARCH_INPUT   : '.site-course-block .form-control'
  }

  const ClassName = {
    OPEN: 'site-course-open'
  }
  ...
  $(document).on('click', Selector.TOGGLE_BUTTON, (event) => {
    ...
    if (button.data('widget') !== 'site-course') {
